...
/* harmony import */ var _js_main_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/main.js */ "./src/public/js/main.js");
...
var app = new Vue(_js_main_js__WEBPACK_IMPORTED_MODULE_2__["default"]);
  ...
  methods: {
    ...
    remove: function remove(product) {
      ...
      if (product.quantity > 1) {
        this.$parent.putJson("/api/cart/".concat(product.id_product), {
          quantity: -1
        }).then(function (data) {
          if (data.result) {
            product.quantity--;
...
/* harmony import */ var _FilterComp_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./FilterComp.js */ "./src/public/js/FilterComp.js");
...
var app = {
  ...
  components: {
    ...
    'filter-el': _FilterComp_js__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  methods: {
